...
class Notification(models.Model):
    ...
    created_by = models.ForeignKey(SpotifyUser, related_name='created_notifications', on_delete=models.CASCADE)
    created_for = models.ForeignKey(SpotifyUser, related_name='received_notifications', on_delete=models.CASCADE)
