<template>
<div class="d-flex align-items-center p-2 rounded border" style="max-width: 400px; background-color: #f8f9fa;">
  <!-- Imagen -->
  <img
    :src="itemData.image"
    alt="cover"
  ...
  <div class="text-truncate flex-grow-1">
    ...
    <a
      ...
      style="max-width: 100%; font-size: 16px;"
    >
      {{ itemData.name }}
    </a>
  ...
  <!-- Logo de Spotify -->
  <div class="ms-2">
    <svg width="24" height="24" viewBox="0 0 236.05 225.25" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        :style="{ fill: '#1ed760', strokeWidth: 0 }"
      />
    </svg>
  </div>
</div>
