    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                ...
                >
                    <h2 class="h5 mb-4">Peticiones de amistad</h2>
                    ...
                    >
                        ...
                        <p>
                            <strong>
                                <RouterLink :to="{ name: 'profile', params: { id: friendshipRequest.created_by.id } }">
                                    {{ friendshipRequest.created_by.display_name  }}
                                </RouterLink>
                            </strong>
                        </p>
                        ...
                        <div class="mt-3">
                            <button class="btn btn-success me-2" @click="handleRequest('accepted', friendshipRequest.created_by.id)">Aceptar</button>
                            <button class="btn btn-danger" @click="handleRequest('rejected', friendshipRequest.created_by.id)">Rechazar</button>
                        </div>
                    </div>
