  ...
  <div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1a1a1a;">
      <div class="container-fluid">
        <a class="navbar-brand fw-bold fs-4 text-white" href="#">Echonet</a>
        <div class="d-none d-lg-flex gap-4 mx-auto" v-if="userStore.user.isAuthenticated">
          <RouterLink to="/feed" class="nav-link text-primary">
            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-house-door" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24" height="24">
              <path stroke-linecap="round" stroke-linejoin="round"
                    d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125
                       ...
                       0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m-13.5
                       3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283
                       3.293.369V21l4.184-4.183a1.14 1.14 0 01.778-.332
                       48.294 48.294 0 005.83-.498c1.585-.233
          ...
          <RouterLink to="/notifications" class="nav-link text-light">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24" height="24">
              <path stroke-linecap="round" stroke-linejoin="round"
                    d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967
                       ...
                       5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714
                       0a3 3 0 11-5.714 0"/>
            </svg>
          </RouterLink>
        ...
        <div class="d-flex align-items-center gap-3">
          <template v-if="userStore.user.isAuthenticated && userStore.user.id">
            <RouterLink :to="{ name: 'profile', params: { id: userStore.user.id } }">
              <img :src="userStore.user.avatar" class="rounded-circle" style="width: 48px; height: 48px;" />
            </RouterLink>
          </template>
          <template v-else>
